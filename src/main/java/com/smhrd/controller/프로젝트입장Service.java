...
@WebServlet("/프로젝트입장Service")
public class 프로젝트입장Service extends HttpServlet {
   ...
   projectDTO projData = dao.getProjData(proj_name);
   
   session.setAttribute("projData", projData);
